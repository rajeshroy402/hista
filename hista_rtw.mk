###########################################################################
## Makefile generated for component 'hista'. 
## 
## Makefile     : hista_rtw.mk
## Generated on : Wed May 05 18:19:40 2021
## Final product: .\hista.lib
...
START_DIR                 = C:\Users\RAJESH~1\MATLAB\Projects\examples\ASBQUA~2\codegen\lib\hista
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -D MODEL=hista
...
SRCS = $(START_DIR)\hista_data.cu $(START_DIR)\hista_initialize.cu $(START_DIR)\hista_terminate.cu $(START_DIR)\hista.cu $(START_DIR)\randn.cu $(START_DIR)\eml_rand.cu $(START_DIR)\eml_rand_mcg16807_stateful.cu $(START_DIR)\eml_rand_shr3cong_stateful.cu $(START_DIR)\eml_randn.cu $(START_DIR)\eml_rand_mt19937ar_stateful.cu
...
OBJS = hista_data.obj hista_initialize.obj hista_terminate.obj hista.obj randn.obj eml_rand.obj eml_rand_mcg16807_stateful.obj eml_rand_shr3cong_stateful.obj eml_randn.obj eml_rand_mt19937ar_stateful.obj
...
hista_data.obj : $(START_DIR)\hista_data.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\hista_data.cu


hista_initialize.obj : $(START_DIR)\hista_initialize.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\hista_initialize.cu


hista_terminate.obj : $(START_DIR)\hista_terminate.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\hista_terminate.cu


hista.obj : $(START_DIR)\hista.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\hista.cu


randn.obj : $(START_DIR)\randn.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\randn.cu


eml_rand.obj : $(START_DIR)\eml_rand.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\eml_rand.cu


eml_rand_mcg16807_stateful.obj : $(START_DIR)\eml_rand_mcg16807_stateful.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\eml_rand_mcg16807_stateful.cu


eml_rand_shr3cong_stateful.obj : $(START_DIR)\eml_rand_shr3cong_stateful.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\eml_rand_shr3cong_stateful.cu


eml_randn.obj : $(START_DIR)\eml_randn.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\eml_randn.cu


eml_rand_mt19937ar_stateful.obj : $(START_DIR)\eml_rand_mt19937ar_stateful.cu
	$(CPP) $(CPPFLAGS) -o  "$@" $(START_DIR)\eml_rand_mt19937ar_stateful.cu
